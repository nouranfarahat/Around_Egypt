 ...
 * Use the [ExperienceDetailsFragment.newInstance] factory method to
...
class ExperienceDetailsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ExperienceDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ExperienceDetailsFragment().apply {
